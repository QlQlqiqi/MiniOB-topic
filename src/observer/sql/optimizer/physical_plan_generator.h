...
private:
  ...
  static RC create_plan(VectorIndexScanLogicalOperator &logical_oper, std::unique_ptr<PhysicalOperator> &oper);
  static RC create_plan(CreateTableSelectLogicalOperator &logical_oper, std::unique_ptr<PhysicalOperator> &oper);
